...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            {!! Form::model($admin, ['method' => 'PATCH','route' => ['profile.update']]) !!}
            ...
            <div class="card-body">    
                ...
                <div class="form-group">
                <label for="input-password">Password <small class="text-secondary">(If you want to change the current password then enter otherwise leave blank)</small></label>    
