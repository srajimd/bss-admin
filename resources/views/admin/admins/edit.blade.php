    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">    
                ...
                {!! Form::select('roles[]', $roles, $adminRole, array('class' => 'form-control','multiple', 'id' => 'input-role')) !!}
                @if ($errors->has('roles'))
                ...
                {!! Form::select('status', array('0' => 'Disabled', '1' => 'Enabled'), $admin->status, array('class' => 'form-control', 'id' => 'input-status')) !!}
                </div>
            </div>
