...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            {!! Form::model($question, ['method' => 'PATCH','route' => ['questions.update', $params]]) !!}
            ...
            <div class="card-body">    
                ...
                {!! Form::select('status', array('0' => 'Disabled', '1' => 'Enabled'), $question->status, array('class' => 'form-control', 'id' => 'input-status')) !!}
                </div>
            </div>
                    ...
                    <table id="answer" class="table table-striped table-bordered table-hover">
                      ...
                      <tbody>
                        ...
                        @php
                            $answer_row = 0;
                        @endphp
                        @foreach(old('answer', $answers) as $key => $value)                       
                        ...
                        <td class="text-right">
                            ...
                            */
                            ...
                            class="form-control">{{ $value['name'] }}</textarea>
            ...
            <div class="card-footer">    
                ...
                <a href="{{ route('questions.index', $qString) }}" class="btn btn-danger">Cancel</a>    
            </div>       
...
function addAnswer() {
    ...
    html += '  <td class="text-right"><textarea name="answer[' + answer_row + '][name]" class="form-control" placeholder="Answer"></textarea></td>';
