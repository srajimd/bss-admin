...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            {!! Form::model($document, ['method' => 'PATCH', 'route' => ['documents.update', $params], 'enctype' => 'multipart/form-data', 'files' => true]) !!}
            ...
            <div class="card-body">    
               ...
               <div class="form-group">
                ...
                <div class="form-group">
                <label for="input-file">PDF</label>  
                <input type="file" name="file" class="form-control" id="input-file">
                <span class="text-danger">Filename : {{ $document->file_name }}</span>                
                @if ($errors->has('file'))
                ...
                {!! Form::select('status', array('0' => 'Disabled', '1' => 'Enabled'), $document->status, array('class' => 'form-control', 'id' => 'input-status')) !!}
                </div>
            </div>
            <div class="card-footer">    
                <button type="submit" class="btn btn-primary">Submit</button>
                <a href="{{ route('documents.index', $qString) }}" class="btn btn-danger">Cancel</a>    
            </div>       
